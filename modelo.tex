...
\documentclass[	12pt,								%Tamanho da Fonte
	...
	\usepackage{listings}					% Insercao de codigos de programacao
	...
	\usepackage{xcolor}						% Adiciona novas Cores
	\usepackage{amsthm}
	...
	%	-----------------------------------------------------------------------------	%
	\lstset{ language=Java,							% Define a linguagem utilizada
	basicstyle=\ttfamily\small,					% Detalhes das Fontes
	keywordstyle=\color{purple}\bfseries,		% Cor e estilo das palavras-chave
	stringstyle=\color{red},					% Cor de Strings
	commentstyle=\color{green},					% Cor dos comentarios
	morecomment=[s][\color{blue}]{/**}{*/},		% Inserindo novo ambiente de comentario
	showspaces=false,							% Exibe todos os espacos
	showstringspaces=false,						% Exibe os espacos das strings somente
	numbers=left,								% Lado onde os numeros das linhas ficam
	numberstyle=\tiny,							% Estilo dos numeros
	breaklines=true,							% Exibe as quebras de linha
	backgroundcolor=\color{cyan!10},			% Cor do fundo da tela
	xleftmargin=0pt,							% Tamanho da margem esquerda
}
	...
	%	--------------------------- Novos Ambiente ----------------------------------	%		
	\newenvironment{observacao}{{\bfseries Observações:} \itshape}{}
	\newtheorem{plain}{Teorema}
...
\input{./elementosPreTextuais/fichaCatalografica/fichaCatalografica.tex}
%\input{./elementosPreTextuais/errata/errata.tex}
\input{./elementosPreTextuais/folhaAprovacao/folhaAprovacao.tex}
\input{./elementosPreTextuais/dedicatoria/dedicatoria.tex}
\input{./elementosPreTextuais/agradecimentos/agradecimentos.tex}
\input{./elementosPreTextuais/epigrafe/epigrafe.tex}
\input{./elementosPreTextuais/resumo/resumo.tex}
\input{./elementosPreTextuais/abstract/abstract.tex}
...
\input{./elementosPreTextuais/siglas/siglas.tex}
\input{./elementosPreTextuais/simbolos/simbolos.tex}
\tableofcontents*

	%	--------------------- Elementos Textuais -----------------------	%

\mainmatter
\input{./elementosTextuais/introducao/introducao.tex}
\input{./elementosTextuais/capitulo_1/capitulo_1.tex}
\input{./elementosTextuais/capitulo_2/capitulo_2.tex}
\input{./elementosTextuais/capitulo_3/capitulo_3.tex}
